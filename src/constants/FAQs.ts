import { type FAQAccordionProps } from '@/components';
...
export const FAQs: FAQAccordionProps[] = [
	...
	},
	{
		...
		answer: `All our communications takes place on Slack. Your brand managers, editors and designers are always present there to answers your concerns`
	},
	{
	...
	},
	{
		...
		answer: `Due to the high quality nature of the work, there will be no refunds issued. But you can pause your subscription whenever you want.`
	}
];

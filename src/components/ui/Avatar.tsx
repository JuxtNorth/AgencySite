...
const avatarVariants = cva('mb-2 size-20 rounded-full bg-surface md:size-36', {
	variants: {
		variant: {
			default: '',
			bordered:
				"relative before:content-[''] before:size-full before:rounded-full before:bg-surface before:-z-[1] mb-4 before:absolute before:scale-[1.14] before:brightness-125 before:left-0 before:top-0"
		}
	}
});

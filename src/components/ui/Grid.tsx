...
export const Grid: FC<GridProps> = (props) => {
	...
	return (
		<div className="relative -z-20 mix-blend-screen" style={{ width, height }}>
			<div
				className={cn(
					'absolute size-full bg-[radial-gradient(ellipse_60%_70%,rgb(var(--blood-red)),black_70%)] mix-blend-multiply lg:bg-[radial-gradient(ellipse_80%_60%,rgb(var(--blood-red)),black_70%)]',
					props.className
				)}
			></div>
			<svg

...
export const Mission: FC<MissionProps> = (props) => {
	return (
		<section className="space-y-snug rounded-2xl bg-surface p-loose md:rounded-3xl md:p-[52px] lg:grid lg:grid-cols-[64%_36%]">
			<article className="mb-loose space-y-snug text-base text-[#ddd] md:space-y-loose md:text-[1.2rem] md:leading-7 lg:mb-0 lg:pr-12">
				<h1 className="text-5xl font-bold text-blood-red md:text-7xl">
